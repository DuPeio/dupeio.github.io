...
var parts = url.split("/"); // Divise l'URL en parties distinctes
var lastPart = parts[parts.length - 1]; // Récupère la dernière partie
...
// quand on descend la page le bouton principal apparait 
// disparait quand on scrollY = debut.offSet
// les deux autres apparaissent quand on clique sur le premier
// disparaissent quand on reclique sur le btn 
// et quand le premier bouton disparait
